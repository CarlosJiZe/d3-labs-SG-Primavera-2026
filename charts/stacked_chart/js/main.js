...
d3.csv('data/stacked_area2.csv').then((data) => {
    ...
    xAxis.selectAll("line").attr("stroke", "#ffffff");
    xAxis.selectAll("path").attr("stroke", "#ffffff");
    xAxis.selectAll("text").attr("fill", "#ffffff");
    
    yAxis.selectAll("line").attr("stroke", "#ffffff");
    yAxis.selectAll("path").attr("stroke", "#ffffff");
